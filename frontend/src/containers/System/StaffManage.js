...
class StaffManage extends Component {
    ...
    * */
    ...
    handleCancel = () => {
        this.setState({
            email: '', password: '', firstname: '', lastname: '', percentOfStaff: '',
    ...
    checkValidateInput = () => {
        let isValid = true;
        let arrInput = [
            'firstname', 'lastname', 'email', 'percentOfStaff',
            'birthday', 'phonenumber', 'gender', 'role', 'address'
        ];
            ...
            if (isValid === true) {
                ...
                if (actions === CRUD_ACTIONS.CREATE) {
                    this.props.createNewUser({
                        ...
                        percentOfStaff: this.state.percentOfStaff,
    ...
    handleEditUserFromParent = async (user, currentPage) => {
        ...
        await this.setState({
            ...
            percentOfStaff: user.percentOfStaff,
    ...
    componentDidUpdate = (prevProps, prevState, snapshot) => {
        ...
        if (prevProps.genderRedux !== this.props.genderRedux) {
            ...
            let gender = arrGenders && arrGenders.length > 0 ? arrGenders[0].key : '';
            this.setState({
        ...
        if (prevProps.roleRedux !== this.props.roleRedux) {
            ...
            let role = arrRoles && arrRoles.length > 0 ? arrRoles[0].key : '';
            this.setState({
                roleArr: arrRoles,
                // role: role
            })
    ...
    render() {
        ...
        let { email, firstname, lastname, phonenumber, address,
            gender, role, birthday, actions, disabled, percentOfStaff
        } = this.state;
        return (
            <div className="overflow-auto user-redux-container">
                <div className="title py-3">
                    <FormattedMessage id="manage-staff.header" />
                </div>
                <div className="user-redux-body">
                    <div className="container">
                        <form className="row g-3">
                            ...
                            <div className="col-lg-3 col-md-3 col-xs-auto">
                                <label className="form-label">
                                    <FormattedMessage id="manage-order.percent" />
                                </label>
                                <input
                                    type="number"
                                    aria-disabled={disabled}
                                    className={disabled === true ? "form-control is-disabled" : "form-control"}
                                    name="percentOfStaff"
                                    value={percentOfStaff}
                                    onChange={(event) => { this.handleOnChangeInput(event, "percentOfStaff") }}
                                />
                            </div>
                            <div className="col-lg-3 col-md-3 col-xs-auto">
                                <label className="form-label">
